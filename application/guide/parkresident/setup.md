...
##Установка Артонит Парк Резидент.  
  Установка программного пакет Артонит Парк Резиденто выполняется с помощью программы parkResident_php_script_setup_2.2.exe.
  
##Настройка Артонит Парк Резидент.  
###Настройка связи с базой данных СКУД.  
Настройка пути к базе данных хранится в файле parkresident\application\config\database.php раздел fb:  
~~~
	'fb' => array(
		'type'			=> 'pdo',
		'connection'	=> array(
